...
export const getConvertCurrency = (fromCurrency: CurrencyCode, toCurrency: CurrencyCode, amount: number): Promise<ConversionResponse> => fetch(`${BASE_URL}/convert?api_key=${API_KEY}
